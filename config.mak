...
LIBAV_CONFIGURATION=--prefix=/usr --arch=armv7l --cpu=cortex-a9 --target-os=linux --cross-prefix=/mnt/sda2/ORION/buildroot.new/output/host/usr/bin/arm-linux-gnueabihf- --enable-cross-compile --enable-pthreads --disable-debug --enable-libmp3lame --enable-libvorbis --enable-nonfree --enable-libx264 --enable-libspeex --enable-libtheora --enable-neon --disable-shared --enable-static --disable-outdev='sdl,xv' --disable-indev=dv1394 --enable-gpl
prefix=/usr
...
SRC_PATH=.
CC_IDENT=gcc 4.8.3 (crosstool-NG linaro-1.13.1-4.8-2013.12 - Linaro GCC 2013.11) 20131202 (prerelease)
ARCH=arm
INTRINSICS=none
CC=/mnt/sda2/ORION/buildroot.new/output/host/usr/bin/arm-linux-gnueabihf-gcc
AS=/mnt/sda2/ORION/buildroot.new/output/host/usr/bin/arm-linux-gnueabihf-gcc
LD=/mnt/sda2/ORION/buildroot.new/output/host/usr/bin/arm-linux-gnueabihf-gcc
DEPCC=/mnt/sda2/ORION/buildroot.new/output/host/usr/bin/arm-linux-gnueabihf-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/mnt/sda2/ORION/buildroot.new/output/host/usr/bin/arm-linux-gnueabihf-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/mnt/sda2/ORION/buildroot.new/output/host/usr/bin/arm-linux-gnueabihf-ar
ARFLAGS=rc
AR_O=$@
RANLIB=/mnt/sda2/ORION/buildroot.new/output/host/usr/bin/arm-linux-gnueabihf-ranlib
STRIP=/mnt/sda2/ORION/buildroot.new/output/host/usr/bin/arm-linux-gnueabihf-strip
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DZLIB_CONST
CFLAGS=   -mcpu=cortex-a9 -std=c99 -fomit-frame-pointer -mthumb -pthread  -I/mnt/sda2/ORION/buildroot.new/output/host/usr/arm-buildroot-linux-gnueabi/sysroot/usr/local/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=declaration-after-statement -Werror=vla -Wno-maybe-uninitialized
...
CFLAGS-avplay=-D_GNU_SOURCE=1 -D_REENTRANT -I/mnt/sda2/ORION/buildroot.new/output/host/usr/arm-buildroot-linux-gnueabi/sysroot/usr/include/SDL
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-lX11 -lasound -L/mnt/sda2/ORION/buildroot.new/output/host/usr/arm-buildroot-linux-gnueabi/sysroot/usr/local/lib -lx264 -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -lspeex -lmp3lame -lm -lbz2 -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
LIBS-avconv=
LIBS-avplay=-Wl,-rpath,/usr/lib -lSDL -lpthread
LIBS-avprobe=
!ARCH_AARCH64=yes
!ARCH_ALPHA=yes
ARCH_ARM=yes
